 ...
 * @constructor
 */
const Radio = ({labelPlacement = 'left', containerClassName, label, id, onChange, value}) => {
    return (
        <div className={`${containerClassName} flex items-center`}>
            ...
            <input
                ...
                onChange={onChange}
                className="
                    h-4 w-4 text-indigo-600 transition duration-150 ease-in-out appearance-none rounded-full
